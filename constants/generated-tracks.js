export const tracks = {
  'EXCELLENCE ': {
    ...
    milestones: [
      {
        summary:
          'M1: Apply best practices towards excellence for Liferay products / projects:',
        signals: [
      ...
      {
        summary:
          'M2: Use your mature knowledge to build and create, starting to help others to grow: ',
        signals: [
      ...
      {
        summary:
          'M3:  Influence people by encouraging them to deliver excellence, driving culture and processes at Liferay.',
        signals: [
      ...
      {
        summary:
          'M4: Achieve or generate significant business value for the company.',
        signals: [
    ...
    description:
      'Producing excellence starts with paying attention to details, both in what you do and in what others do. This track measures your ability to produce high-quality outcomes in your daily work consistently.',
  },
  COLLABORATION: {
    ...
    milestones: [
      {
        summary:
          'M1: Help others as you can, giving and receiving feedback effectively and efficiently',
        signals: [
      ...
      {
        summary:
          'M3: How can I lead communication and collaboration across teams/products/projects?',
        signals: [
      ...
      {
        summary:
          'M4:  Achieve, internally and starting in the industry, significant communication and collaboration goals for the company.',
        signals: [
          'Share your knowledge (continuously and consistently) to the outside world (conferences, workshops, meetups, etc.). ',
  ...
  IMPACT: {
    ...
    milestones: [
      {
        summary:
          'M1: An effective team player who finds ways to serve others..',
        signals: [
      ...
      {
        summary:
          'M3:  Designer who can Influence people/Teams/Products/Projects',
        signals: [
      ...
      {
        summary:
          'M4:  Designer who has achieved (internally and starting in the industry) significant goals for the company in terms of Products, etc.',
        signals: [
      ...
      {
        summary: 'M5:  Person that influences the industry.',
        signals: ['Architecting Community/Industry initiatives:  Aaron Walter'],
      },
    ],
    description:
  ...
  ADVOCACY: {
    ...
    milestones: [
      {
        summary:
          'M1: Represents Liferay well externally, interacting with customers, etc.',
        signals: [
      ...
      {
        summary:
          'M2:  Builds industry relationships and supports others’ initiatives',
        signals: [
      ...
      {
        summary:
          'M4:  Achieved significant internal goals for the company and has started to become noticed in the industry.',
        signals: [
      ...
      },
      {
        ...
        signals: ['I.e. John Maeda, Daniel Burka, Jesse James Garrett'],
      },
    ],
    description:
  ...
  INFLUENCE: {
    ...
    milestones: [
      {
        summary:
          'M1:  Embodies self-mastery and personal responsibility, takes initiative to serve the team.',
        signals: [
      ...
      {
        summary:
          'M2:  Is an example to many, mentors a few. Has some explicit responsibilities which requires ensuring other’s well-being, while delivering expected results.',
        signals: [
      ...
      {
        summary:
          'M4:  Provides vision at an Organizational level. Assumes more complex responsibilities, such as leading a large or distributed team. ',
        signals: [
      ...
      {
        summary:
          'M5:  Provides vision at an industry level, impacting all levels for many years, helping to shape the industry',
        signals: [
  ...
  RESEARCH: {
    ...
    milestones: [
      ...
      { summary: 'M5: Architect', signals: ['Bill Buxton, Erika Hall'] },
    ],
    description:
  ...
  ENGINEERING: {
    ...
    description:
      'Engineering in the context of design is the ability to understand technology, contribute to the engineering team to solve problems and create tools to improve the design lifecycle.',
  },
}
